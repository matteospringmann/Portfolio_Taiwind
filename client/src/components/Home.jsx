...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>Mattéo Springmann - Développeur Frontend React</title>
        <meta
          name="description"
          content="Portfolio de Mattéo Springmann, développeur React et Node.js. Découvrez mes projets, mes compétences et mon parcours à Epitech."
        />
      </Helmet>
      <section
        id="Accueil"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Étudiant en informatique et développeur front-end spécialisé dans
              la création d'applications web modernes et intuitives avec React
              et Tailwind CSS.
            </p>
