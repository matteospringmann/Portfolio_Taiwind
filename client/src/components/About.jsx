        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-5 gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="space-y-6 text-lg text-gray-700">
              <p>
                Je suis Mattéo Springmann, étudiant en 2ème année à
                <a
                ...
                . Actuellement en Master d'Informatique, je me spécialise dans
                le développement front-end avec un fort intérêt pour la création
                d'interfaces utilisateur intuitives et performantes.
              </p>
              <p>
                Ce portfolio est le reflet de mon apprentissage et de ma passion
                pour la technologie. Vous y découvrirez mes projets, mes
                compétences techniques, et la manière dont j'approche la
            ...
            <div className="mt-10 space-y-6">
              {qualities.map((quality) => (
                <div key={quality.name} className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">{quality.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-2 flex justify-center lg:justify-end">
            <div className="flex flex-col items-center gap-6 w-full max-w-xs text-center">
              ...
              <p className="text-sm text-gray-500">
                Étudiant en 2ème année, programme Grande École (PGE 2028).
              </p>
              <a
                href={cvFile}
                download="matteo_springmanncv.pdf"
